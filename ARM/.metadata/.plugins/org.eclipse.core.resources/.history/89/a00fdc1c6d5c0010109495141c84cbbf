...
void AUTO01(void *argument)
{
  ...
  for(;;)
  {
    if(currentState == 1)
          {
              if(distance_C < safeDistance && distance_L < safeDistance && distance_R < safeDistance)
              {
                  stopMove();
                  backwordMove();
              }

              else if(distance_C < safeDistance && distance_L > safeDistance && distance_R > safeDistance)
              {
                  stopMove();
